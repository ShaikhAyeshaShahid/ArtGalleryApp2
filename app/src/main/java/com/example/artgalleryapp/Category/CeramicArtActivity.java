...
public class CeramicArtActivity extends AppCompatActivity {
    private Button cart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ceramic_art);
        ...
        /*custom = (Button) findViewById(R.id.btn_custom1);
...
*/
    ...
    /*private void customization() {
        Intent intent = new Intent(CeramicArtActivity.this, CustomizationActivity.class);
