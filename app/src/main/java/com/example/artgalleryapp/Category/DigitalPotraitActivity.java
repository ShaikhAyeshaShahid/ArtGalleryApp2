...
public class DigitalPotraitActivity extends AppCompatActivity {
    private Button cart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_digital_potrait);
        ...
        firebaseDatabase.getReference().child("DigitalPotrait").addListenerForSingleValueEvent(new ValueEventListener()
        {
            @Override
       ...
       /* customize = (Button) findViewById(R.id.btn_potrcustom1);
    ...
    /*private void customize() {
        Intent intent = new Intent(DigitalPotraitActivity.this, CustomizationActivity.class);
