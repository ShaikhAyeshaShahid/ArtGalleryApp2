...
public class AbstractActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        firebaseDatabase.getReference().child("AbstarctArt").addListenerForSingleValueEvent(new ValueEventListener()
        {
            @Override
        ...
        customization = (Button) findViewById(R.id.btn_customize);

        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //FragmentTransaction fragmentTransaction = getSupportFragmentManager().beginTransaction();
                //fragmentTransaction.replace(R.id.cart, new CartFragment()).commit();
            }
        });
    ...
    private void customization() {
        Intent intent = new Intent(AbstractActivity.this, CustomizationActivity.class);
