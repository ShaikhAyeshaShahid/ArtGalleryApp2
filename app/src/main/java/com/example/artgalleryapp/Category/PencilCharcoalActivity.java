...
public class PencilCharcoalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pencil_charcoal);
        ...
        firebaseDatabase.getReference().child("CharcoalPencil").addListenerForSingleValueEvent(new ValueEventListener()
        {
            @Override
        ...
        /*custom = (Button) findViewById(R.id.btn_pencustom1);
...
*/
   ...
   /* private void custom() {
        Intent intent = new Intent(PencilCharcoalActivity.this, CustomizationActivity.class);
