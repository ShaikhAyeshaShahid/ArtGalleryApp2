...
public class SufismActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sufism);
        ...
        firebaseDatabase.getReference().child("CSufismDarweish").addListenerForSingleValueEvent(new ValueEventListener()
        {
            @Override
       ...
       /* custom = (Button) findViewById(R.id.btn_suficustom1);
   ...
   /* private void custom() {
        Intent intent = new Intent(SufismActivity.this, CustomizationActivity.class);
