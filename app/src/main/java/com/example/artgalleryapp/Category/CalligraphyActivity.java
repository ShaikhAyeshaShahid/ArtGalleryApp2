...
public class CalligraphyActivity extends AppCompatActivity
{
    ...
    protected void onCreate (Bundle savedInstanceState)
    {
        ...
        firebaseDatabase.getReference().child("Calligraphy").addListenerForSingleValueEvent(new ValueEventListener()
        {
            @Override
        ...
        /*customize = (Button) findViewById(R.id.btn_calligraphycustom1);
    ...
    /*private void customization() {
        Intent intent = new Intent(CalligraphyActivity.this, CustomizationActivity.class);
