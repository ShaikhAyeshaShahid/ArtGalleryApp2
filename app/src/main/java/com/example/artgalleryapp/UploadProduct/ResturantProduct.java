...
public class ResturantProduct extends AppCompatActivity
{
    ...
    protected void onCreate (Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_resturant_product);
        ...
        submit.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick (View v)
            {
                ...
                final StorageReference reference = firebaseStorage.getReference().child("Resturant")
                    ...
                    public void onSuccess (UploadTask.TaskSnapshot taskSnapshot)
                    {
                        reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>()
                        {
                            ...
                            public void onSuccess (Uri uri)
                            {
                                ...
                                database.getReference().child("Resturant").push().setValue(model)
                                        .addOnSuccessListener(new OnSuccessListener<Void>()
                                        {
                                            @Override
                                            public void onSuccess (Void unused)
                                            {
                                                Toast.makeText(ResturantProduct.this, "Product Upload Successfully", Toast.LENGTH_SHORT).show();
                                                dialog.dismiss();
                                            }
                                        }).addOnFailureListener(new OnFailureListener()
                                        {
                                            ...
                                            {
                                                dialog.dismiss();
                                                Toast.makeText(ResturantProduct.this, "Error", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            }
                        });
    ...
    private void UploadImage ( )
    {
        Dexter.withContext(this)
                ...
                .withListener(new PermissionListener()
                {
                    ...
                    {
                        Toast.makeText(ResturantProduct.this, "Permission Denied", Toast.LENGTH_SHORT).show();
                    }
