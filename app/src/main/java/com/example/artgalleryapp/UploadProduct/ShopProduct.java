    ...
    protected void onCreate (Bundle savedInstanceState)
    {
        ...
        submit.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick (View v)
            {
                ...
                final StorageReference reference = firebaseStorage.getReference().child("Shop")
                    ...
                    public void onSuccess (UploadTask.TaskSnapshot taskSnapshot)
                    {
                        reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>()
                        {
                            ...
                            public void onSuccess (Uri uri)
                            {
                                ...
                                database.getReference().child("Shop").push().setValue(model)
                                        .addOnSuccessListener(new OnSuccessListener<Void>()
                                        {
                                            @Override
                                            public void onSuccess (Void unused)
                                            {
                                                Toast.makeText(ShopProduct.this, "Product Upload Successfully", Toast.LENGTH_SHORT).show();
                                                dialog.dismiss();
                                            }
                                        }).addOnFailureListener(new OnFailureListener()
                                        {
                                            ...
                                            {
                                                dialog.dismiss();
                                                Toast.makeText(ShopProduct.this, "Error", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            }
                        });
    ...
    private void UploadImage ( )
    {
        Dexter.withContext(this)
                ...
                .withListener(new PermissionListener()
                {
                    ...
                    {
                        Toast.makeText(ShopProduct.this, "Permission Denied", Toast.LENGTH_SHORT).show();
                    }
