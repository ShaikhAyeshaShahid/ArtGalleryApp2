...
import com.example.artgalleryapp.ConfirmOrderActivity;
import com.example.artgalleryapp.DrawerActivity;
import com.example.artgalleryapp.Product.SingleProductActivity;
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick (View view)
                    {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener()
                        {
                            ...
                            {
                                if (i == 0) {
                                    Intent intent = new Intent(CartActivity.this, SingleProductActivity.class);
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>()
                                            {
                                                ...
                                                public void onComplete (@NonNull Task<Void> task)
                                                {
                                                    if (task.isSuccessful()) {
                                                        ...
                                                        Intent intent = new Intent(CartActivity.this, DrawerActivity.class);
                                                        startActivity(intent);
                                                    }
                                                }
                                            });
